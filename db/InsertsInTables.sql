-- ============================================================================
-- Script de Inserción de Datos Iniciales - PostgreSQL 14+
-- Entorno: Windows
-- Ejecución: Atómica con limpieza previa
-- ============================================================================

BEGIN;

-- ============================================================================
-- LIMPIEZA COMPLETA: Vaciar tablas y reiniciar secuencias
-- ============================================================================

TRUNCATE TABLE
  marketing_configurations,
  operation_progress,
...
INSERT INTO literals(id, name, active, created_by, updated_by)
OVERRIDING SYSTEM VALUE
VALUES
...
-- ============================================================================
-- DATOS TEMPORALES: Meses (IDs manuales requeridos)
-- ============================================================================

INSERT INTO months(id, name, created_by, updated_by)
OVERRIDING SYSTEM VALUE
VALUES
(0, 'Configuracion', 1, 1),
(1, 'Enero', 1, 1),
...
('A1', 'Material base estructural', 950, 'Kilogramo', 4050, 1, 1),
('A2', 'Material de revestimiento', 570, 'Litro', 5950, 1, 1),
('A3', 'Material de refuerzo', 425, 'Kilogramo', 5100, 1, 1),
('A4', 'Componente principal Alfaros', 1980, 'Unidad', 3900, 1, 1),
('A5', 'Componente secundario Alfaros', 1330, 'Unidad', 4950, 1, 1),
('A6', 'Componente principal Betacos', 625, 'Metro', 5800, 1, 1),
('A7', 'Componente secundario Betacos', 960, 'Unidad', 4150, 1, 1),
('A8', 'Componente principal Gamaroles', 335, 'Kilogramo', 9600, 1, 1),
('A9', 'Componente secundario Gamaroles', 640, 'Unidad', 6900, 1, 1),
('A10', 'Material de acabado', 575, 'Litro', 8100, 1, 1);

INSERT INTO product_inventory(product_id, quantity, unit_cost, credit30, credit60, investment_percent, created_by, updated_by) VALUES 
(1, 80, 100000, 0, 0, 0, 1, 1),
(2, 60, 97000, 0, 0, 0, 1, 1),
(3, 30, 88000, 0, 0, 0, 1, 1);
...
INSERT INTO specifications(name, base_capacity, setup_time, production_time, maintenance_time, daily_standard_output, max_monthly_capacity, created_by, updated_by) VALUES
...
OVERRIDING SYSTEM VALUE
VALUES 
(1, 'Gestión administrativa estratégica', 'El CEO optimiza la gestión general y toma decisiones clave.', '{"efficiency_multiplier": 1.05, "administrative_control": true}', 1),
(2, 'Mayor producción', 'Aumenta el rendimiento de la producción mediante mejoras operativas.', '{"productivity_boost": 0.12, "error_reduction": 0.05}', 1),
(3, 'Estrategia de ventas básica', 'Aumenta el flujo de clientes y aplica comisión sobre ventas.', '{"sales_boost": 0.10, "commission": 0.01}', 1),
(4, 'Optimización de producción', 'Optimiza distribución de producción, alerta sobre eficiencia y reduce errores.', '{"production_distribution": "optimized", "efficiency_alerts": true, "error_reduction": 0.15}', 1),
(5, 'Gestión de inventario', 'Alertas automáticas de stock y reducción de desabastecimiento.', '{"stock_alerts": true, "order_optimization": true, "stockout_risk_reduction": 0.20}', 1),
(6, 'Contabilidad automatizada', 'Estados financieros automáticos, alertas de pagos y reducción de errores contables.', '{"financial_statements": "automated", "payment_alerts": true, "accounting_error_reduction": 0.25}', 1),
(7, 'Gestión administrativa secundaria', 'Organización de pagos y reducción de pagos tardíos.', '{"payment_organization": true, "due_date_alerts": true, "late_payment_reduction": 0.10}', 1);

INSERT INTO payroll_role_improvements(role_id, improvement_id) VALUES
(1, 1),
(2, 2),
(3, 3),
(4, 4),
...
-- ============================================================================
-- DATOS DE PROVEEDORES Y MATERIALES
-- ============================================================================

INSERT INTO providers(id, name, logo_filename, description, location, delivery_time, volume_discount)
OVERRIDING SYSTEM VALUE
VALUES 
...
INSERT INTO materials(id, code, name, description, unit_id, base_price)
OVERRIDING SYSTEM VALUE
VALUES
...
(1, 1, 4200, 1), (1, 2, 6300, 1), (1, 3, 4950, 1), (1, 4, 4100, 1), (1, 5, 4950, 1),
(1, 6, 6150, 1), (1, 7, 4250, 1), (1, 8, 9800, 1), (1, 9, 7200, 1), (1, 10, 8400, 1),
(2, 1, 3800, 1), (2, 2, 5850, 1), (2, 3, 5250, 1), (2, 4, 3900, 1), (2, 5, 5200, 1),
(2, 6, 5700, 1), (2, 7, 4150, 1), (2, 8, 10500, 1), (2, 9, 6800, 1), (2, 10, 7600, 1),
(3, 1, 4100, 1), (3, 2, 6200, 1), (3, 3, 4700, 1), (3, 4, 3800, 1), (3, 5, 5300, 1),
(3, 6, 6400, 1), (3, 7, 3850, 1), (3, 8, 10200, 1), (3, 9, 7500, 1), (3, 10, 8300, 1),
(4, 1, 4050, 1), (4, 2, 5950, 1), (4, 3, 5100, 1), (4, 4, 4200, 1), (4, 5, 4750, 1),
(4, 6, 5800, 1), (4, 7, 4150, 1), (4, 8, 9600, 1), (4, 9, 6900, 1), (4, 10, 8100, 1);
...
-- Necesario porque usamos OVERRIDING SYSTEM VALUE en algunas tablas
-- ============================================================================
